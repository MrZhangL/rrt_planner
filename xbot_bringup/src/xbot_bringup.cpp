...
ROS_INFO("cmd_vel initialized successful.");
  //RobotV_ = 1000; //机器人的速度 
...
{ 
 ...
 //ros::Subscriber sub = n.subscribe("navigation_velocity_smoother/raw_cmd_vel", 100, cmdCallback); 
 ros::Subscriber sub = n.subscribe("cmd_vel_mux/input/teleop", 100, cmdCallback); 
