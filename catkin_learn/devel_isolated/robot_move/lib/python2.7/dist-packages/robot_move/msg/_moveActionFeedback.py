...
"""autogenerated by genpy from robot_move/moveActionFeedback.msg. Do not edit."""
import sys
...
class moveActionFeedback(genpy.Message):
  _md5sum = "42cee42e91ff52f575a0bfc3d75b59e6"
  _type = "robot_move/moveActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot_move/moveFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = robot_move.msg.moveFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = robot_move.msg.moveFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_3f().pack(_x.feedback.n_x, _x.feedback.n_y, _x.feedback.n_z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.n_x, _x.feedback.n_y, _x.feedback.n_z,) = _get_struct_3f().unpack(str[start:end])
      return self
