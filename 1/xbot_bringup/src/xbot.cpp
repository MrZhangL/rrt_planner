...
//机器人的尺寸参数 
const double ROBOT_WIDTH = 330.00; //圆形此处改为直径 
...
ROS_INFO("received%f,%f,%f,%f",vel_left_front.odoemtry_float,vel_right_front.odoemtry_float,vel_left_back.odoemtry_float,vel_right_back.odoemtry_float);
    ...
    vth_= (vel_left_front.odoemtry_float - vel_right_front.odoemtry_float + vel_left_back.odoemtry_float - vel_right_back.odoemtry_float) / 4/(ROBOT_WIDTH + ROBOT_LENGTH);
...
//自转
 ...
 buf[1] = 0xaa;
    ...
    length = 10; 
    buf[4] = length; 
  // right_front_data.d=left_front_data.d=left_back_data.d=right_back_data.d=500;
...
ROS_INFO("send%d,%d,%d,%d,%d",right_front_data.d,left_front_data.d,left_back_data.d,right_back_data.d,imu_yaw.d);
